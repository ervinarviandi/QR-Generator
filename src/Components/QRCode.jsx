  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-8 lg:flex-nowrap lg:max-w-4xl mx-auto px-4 mt-20">
      <div className="w-full flex flex-col items-center gap-4 lg:items-start">
        <div>
          <QRCodeCanvas id="myQrCode" value={text} className="canvas border-8 border-white " size={265} style={{ backgroundColor: "bg-pink-500", level: "M", marginSize: "true" }} />
          <span value={text} className="break-words text-gray-400 font-poppins text-2xl"></span>
      ...
      <div className="w-full flex flex-col items-center gap-4 lg:items-end">
        <div id="qr-code-wrapper">
          ...
          <div className="input">
            <input
              className="font-poppins text-base py-3 px-2 w-full bg-slate-200 dark:text-black p-3 rounded-md focus:outline-none focus:ring-yellow-500 focus:ring-2 focus:border-yellow-500 "
